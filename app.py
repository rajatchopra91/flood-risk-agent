...
EXAMPLES_HTML = (
    ...
    "<div style='color:#555;'>Residential complex · Monsoon</div></button>"
    ...
    "<div style='color:#555;'>Construction site · Monsoon</div></button>"
    ...
    "<div style='color:#555;'>Warehouse · Dry Season</div></button>"
    ...
    "<div style='color:#555;'>Data center · Post-monsoon</div></button>"
    "</div></div>"
)
